...
public class UserController {
  ...
  public ResponseEntity<ResponseDto<UserDto>> getUser(@ValidUUID @PathVariable UUID uuid) {
    return ResponseEntity.status(HttpStatus.OK)
        .body(new ResponseDto<>(userService.getById(uuid), FOUND, true));
  }
  ...
  public ResponseEntity<ResponseDto<Role>> updateRole(
    ...
    return ResponseEntity.status(HttpStatus.OK).body(new ResponseDto<>(role, UPDATED_ROLE, true));
  }
  ...
  public ResponseEntity<ResponseDto<Role>> updatePassword(
    ...
    return ResponseEntity.status(HttpStatus.OK)
        .body(new ResponseDto<>(null, UPDATED_PASSWORD, true));
  }
}
