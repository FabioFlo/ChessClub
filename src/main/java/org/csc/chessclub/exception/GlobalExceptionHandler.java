...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ResponseDto<ErrorMessage>> handleCustomNotFoundException(
    ...
    ErrorMessage error =
        new ErrorMessage(ex.getMessage(), HttpStatus.NOT_FOUND.value(), Instant.now().toString());
  ...
  public ResponseEntity<ResponseDto<ErrorMessage>> handleCustomBadRequestException(
    ...
    ErrorMessage error =
        new ErrorMessage(ex.getMessage(), HttpStatus.BAD_REQUEST.value(), Instant.now().toString());
