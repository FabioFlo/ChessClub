...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ResponseDto<ErrorMessage>> handleCustomBadRequestException(CustomBadRequestException ex) {
        ErrorMessage error = new ErrorMessage(
    ...
    public ResponseEntity<ResponseDto<ErrorMessage>> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
        ErrorMessage error = new ErrorMessage(
                ex.getMessage(), HttpStatus.BAD_REQUEST.value(), Instant.now().toString());
