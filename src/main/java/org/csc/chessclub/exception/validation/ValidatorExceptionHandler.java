...
public class ValidatorExceptionHandler {
  ...
  public ResponseEntity<ResponseDto<ValidErrorMessage>> validationExceptions(
    ...
    ValidErrorMessage validationError =
        new ValidErrorMessage(HttpStatus.BAD_REQUEST.value(), violations);

    return ResponseEntity.status(HttpStatus.BAD_REQUEST)
        .body(new ResponseDto<>(validationError, "Validation failed", false));
  }
