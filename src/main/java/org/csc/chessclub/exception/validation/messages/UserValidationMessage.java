...
public final class UserValidationMessage {
  ...
  public static final String USERNAME_LENGTH_REQUIRED =
  ...
  public static final String EMAIL_LENGTH_REQUIRED =
      "Email should be between "
          + UserConstraints.EMAIL_MIN_LENGTH
          + " and "
          + UserConstraints.EMAIL_MAX_LENGTH
          + " characters";
}
