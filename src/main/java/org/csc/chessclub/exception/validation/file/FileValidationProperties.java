...
/**
 * This class read the allowed file 'Extensions' and 'Mime Types' values that are under the specified prefix in the properties file.

 * The Default prefix is: 'file.upload'.
 * Example:
 * file.upload.allowed-extensions=.pdf
