...
public final class EventValidationMessage {
  ...
  public static final String TITLE_LENGTH_REQUIRED =
      "Title must be between "
          ...
          + " and "
          + EventConstraints.TITLE_MAX_LENGTH
          + " characters";
  public static final String AUTHOR_LENGTH_REQUIRED =
      "Author must be between "
          + EventConstraints.AUTHOR_MIN_LENGTH
          + " and "
          + EventConstraints.AUTHOR_MAX_LENGTH
          + " characters";
  public static final String DESCRIPTION_LENGTH_REQUIRED =
      "Description must be between "
          + EventConstraints.DESCRIPTION_MIN_LENGTH
          + " and "
          + EventConstraints.DESCRIPTION_MAX_LENGTH
          + " characters";
}
