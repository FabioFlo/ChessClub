...
public final class TournamentMockData {
  public static final String AMAZING_TOURNAMENT_TITLE_FIRST =
      "The amazing local chess tournament - first edition";
  public static final String AMAZING_TOURNAMENT_TITLE_SECOND =
      "The amazing local chess tournament - second edition";
    ...
    List<TournamentEntity> tournamentEntities =
        List.of(
            ...
            TournamentEntity.builder()
                ...
                .description(
                    "The second edition of the best chess event of the city! At the same place and time, are you ready to test your skills?")
