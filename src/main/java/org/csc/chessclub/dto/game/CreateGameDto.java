...
public record CreateGameDto(
    @Size(
            max = GameConstraints.PLAYER_MAX_LENGTH,
            message = GameValidationMessage.PLAYER_NAME_TOO_LONG)
    ...
    @NotBlank(message = GameValidationMessage.PGN_MUST_NOT_BE_BLANK) String pgn,
