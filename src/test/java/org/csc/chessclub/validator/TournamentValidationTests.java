...
public class TournamentValidationTests extends BaseValidatorConfig {
  ...
  void testValidationCreateTournamentDto_whenTitleIsBlank_thenValidationFails() {
    createTournamentDto =
        new CreateTournamentDto("", START_DATE, END_DATE, DESCRIPTION, null, EVENT_ID);

    propertyPath = "title";
    Set<ConstraintViolation<CreateTournamentDto>> violations =
        validator.validate(createTournamentDto);
    ...
    assertThat(violations)
        .anyMatch(
            v ->
                v.getPropertyPath().toString().equals(propertyPath)
                    && v.getMessage()
                        .equals(TournamentValidationMessage.DESCRIPTION_MUST_NOT_BE_BLANK));
  }
  ...
  void testValidationCreateTournamentDto_whenTitleSizeTooShort_thenValidationFails() {
    ...
    propertyPath = "title";
    createTournamentDto =
        new CreateTournamentDto(tooShortTitle, START_DATE, END_DATE, DESCRIPTION, null, null);
  ...
  void testValidationCreateTournamentDto_whenTitleSizeTooLong_thenValidationFails() {
    ...
    propertyPath = "title";
    createTournamentDto =
        new CreateTournamentDto(tooLongTitle, START_DATE, END_DATE, DESCRIPTION, null, null);
  ...
  void testValidationCreateTournamentDto_whenDescriptionSizeTooLong_thenValidationFails() {
    ...
    propertyPath = "description";
    createTournamentDto =
        new CreateTournamentDto(TITLE, START_DATE, END_DATE, tooLongDescription, null, null);
    ...
    assertThat(violations)
        .anyMatch(
            v ->
                v.getPropertyPath().toString().equals(propertyPath)
                    && v.getMessage()
                        .equals(TournamentValidationMessage.DESCRIPTION_LENGTH_REQUIRED));
  }
  ...
  void testValidationCreateTournamentDto_whenDescriptionSizeTooShort_thenValidationFails() {
    ...
    propertyPath = "description";
    createTournamentDto =
        new CreateTournamentDto(TITLE, START_DATE, END_DATE, tooShortDescription, null, null);
  ...
  void testValidationUpdateTournamentDto_whenUUIDNotValid_thenValidationFails() {
    updateTournamentDto =
        new UpdateTournamentDto(null, TITLE, START_DATE, END_DATE, DESCRIPTION, null, null);

    propertyPath = "uuid";
    Set<ConstraintViolation<UpdateTournamentDto>> violations =
        validator.validate(updateTournamentDto);
    assertThat(violations)
        .anyMatch(
            v ->
                v.getPropertyPath().toString().equals(propertyPath)
  ...
  void testValidationUpdateTournamentDto_whenValidUpdateDtoProvided_thenValidationPasses() {
    updateTournamentDto =
        new UpdateTournamentDto(
            UUID.randomUUID(), TITLE, START_DATE, END_DATE, DESCRIPTION, null, null);
