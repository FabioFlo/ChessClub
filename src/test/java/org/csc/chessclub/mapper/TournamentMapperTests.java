...
public class TournamentMapperTests {
    ...
    void shouldMapPageOfTournamentEntityToPageOfTournamentDto() {
        ...
        Page<TournamentEntity> pageOfTournament = new PageImpl<>(listTournaments, pageable,
                listTournaments.size());

        Page<TournamentDto> result = tournamentMapper.pageTournamentEntityToPageTournamentDto(
                pageOfTournament);
