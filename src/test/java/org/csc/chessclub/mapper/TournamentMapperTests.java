...
public class TournamentMapperTests {
  ...
  void shouldMapTournamentEntityToTournamentDto() {
    ...
    assertAll(
        "Map tournament to dto assertions",
        () -> assertEquals(tournament.getUuid(), tournamentDto.uuid(), "UUID should be equal"),
        () -> assertEquals(tournament.getTitle(), tournamentDto.title(), "Title should be equal"),
        () ->
            assertEquals(
                tournament.getStartDate(), tournamentDto.startDate(), "Start date should be equal"),
        () ->
            assertEquals(
                tournament.getEndDate(), tournamentDto.endDate(), "End game should be equal"),
        () ->
            assertEquals(
        ...
        () ->
            assertEquals(tournament.getWinner(), tournamentDto.winner(), "Winner should be equal"));
  }
  ...
  void shouldMapCreateTournamentDtoToTournamentEntity() {
    CreateTournamentDto tournamentDto =
        new CreateTournamentDto(TITLE, START_DATE, END_DATE, DESCRIPTION, WINNER, EVENT_ID);
    TournamentEntity tournamentEntity =
        tournamentMapper.createTournamentDtoToTournamentEntity(tournamentDto);

    assertAll(
        "Map create tournament dto to entity assertions",
        () ->
            assertEquals(
                tournamentEntity.getTitle(), tournamentDto.title(), "Title should be equal"),
        () ->
            assertEquals(
        ...
        () ->
            assertEquals(
                tournamentEntity.getEndDate(), tournamentDto.endDate(), "End game should be equal"),
        () ->
            assertEquals(
                tournamentEntity.getDescription(),
                tournamentDto.description(),
                "Description should be equal"),
        () ->
            assertEquals(tournament.getWinner(), tournamentDto.winner(), "Winner should be equal"),
        () ->
            assertEquals(
                tournamentEntity.getEvent().getUuid(),
                tournamentDto.eventId(),
  ...
  void shouldMapPageOfTournamentEntityToPageOfTournamentDto() {
    ...
    Page<TournamentEntity> pageOfTournament =
        new PageImpl<>(listTournaments, pageable, listTournaments.size());

    Page<TournamentDto> result =
        tournamentMapper.pageTournamentEntityToPageTournamentDto(pageOfTournament);
  ...
  void shouldMapUpdateTournamentDtoToTournamentEntity() {
    UpdateTournamentDto tournamentDto =
        new UpdateTournamentDto(
            UUID.randomUUID(), TITLE, START_DATE, END_DATE, DESCRIPTION, WINNER, EVENT_ID);
    TournamentEntity tournamentEntity =
        tournamentMapper.updateTournamentToTournament(tournamentDto, tournament);
    assertAll(
        "Map update tournament to entity assertions",
        () ->
            assertEquals(tournamentEntity.getUuid(), tournamentDto.uuid(), "UUID should be equal"),
        () ->
            assertEquals(
                tournamentEntity.getTitle(), tournamentDto.title(), "Title should be equal"),
        () ->
        ...
        () ->
            assertEquals(
                tournamentEntity.getWinner(), tournamentDto.winner(), "Winner should be equal"),
        () ->
            assertEquals(
                tournamentEntity.getEvent().getUuid(),
                tournamentDto.eventId(),
