...
public class GameRepositoryTests extends BaseTestConfiguration {
    ...
    void testFindByPlayerName_whenPlayerNameGiven_returnGamesWithGivenPlayerName() {
        ...
        Page<GameEntity> gamesRetrieved = gameRepository.findByAvailableTrueAndWhitePlayerNameOrBlackPlayerNameIs(
        ...
        assertAll("Game search by player name",
                ...
                () -> assertTrue(gamesRetrieved.getContent().stream().allMatch(GameEntity::isAvailable),
                        "All games should have available true"),
                () -> assertEquals(3, gamesRetrieved.getTotalElements(),
                        "Should return 3 games with player name " + playerName),
                () -> assertFalse(gamesRetrieved.getContent().isEmpty(),
                        "The game list should not be empty")
        );
    }
    ...
    void testFindByPlayerName_whenPlayerNameGivenIsNN_returnGamesWithGivenPlayerName() {
        ...
        assertAll("Game search by player name",
                ...
                () -> assertEquals(1, gamesRetrieved.getTotalElements(),
    ...
    void testFindByPlayerName_whenPlayerNameGiven_shouldReturnAllGamesWhereIsTheWhitePlayerName() {
        ...
        Page<GameEntity> gamesRetrieved = gameRepository.findByAvailableTrueAndWhitePlayerNameIs(
                playerName, pageable);
    ...
    void testFindByPlayerName_whenPlayerNameGiven_shouldReturnAllGamesWhereIsTheBlackPlayerName() {
        ...
        Page<GameEntity> gamesRetrieved = gameRepository.findByAvailableTrueAndBlackPlayerNameIs(
                playerName, pageable);
