...
public class GameServiceUnitTests {
  ...
  public void testUpdateGame_whenGameWithEmptyWhiteOrBlackPlayerNameProvided_thenPlayerNameShouldBeSetToNN() {
    ...
    UpdateGameDto gameDto = new UpdateGameDto(uuid, whitePlayer, blankPlayerName, pgn, result,
        null);
  ...
  public void testGetAllGames_whenPlayerNameProvided_returnGamesWhereIsTheWhitePlayer() {
    ...
    when(gameRepository.findByAvailableTrueAndWhitePlayerNameIs(whitePlayer, pageable)).thenReturn(
        pagedGames);
  ...
  public void testGetAllGames_whenPlayerNameProvided_returnGamesWhereIsTheBlackPlayer() {
    ...
    when(gameRepository.findByAvailableTrueAndBlackPlayerNameIs(blackPlayer, pageable)).thenReturn(
        pagedGames);
